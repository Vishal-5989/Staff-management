package com.staffmanagement.commonUtils;
...
public interface LogMessage {
    ...
    String AFTER_CALLING_OPERATION = "After calling operation";
    String BEFORE_CREATING_FILE = "Before File Creation";
    String BEFORE_DOWNLOAD_FILE = "Before File Download";
    String AFTER_CREATING_FILE = "After File Creation";
    String AFTER_DOWNLOAD_FILE = "After File Download";
